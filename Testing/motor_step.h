// header file for stepping the motors using the step and dir pins
...
// Initialize all motors (SPI + GPIO)
int motor_init(void);
...
// Add this to motor_step.h after the other function declarations
