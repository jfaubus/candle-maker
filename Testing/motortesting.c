// This was test program for testing the lead screw motor and wax dispensing motor (not including in state machine)
// uses the motor_move function from motors.c
// I used AI to make the error messages so its a little much 
...
void main(void) {
    ...
    if (err < 0) {
        ...
        printk("Cant continue. Check connections and devicetree.\n");
        return;
    }
